...
//	private static File table;
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("ExcelCounter v0.6a" +
				...
				"\nПриложение разработано исключительно для подсчета красных и желтых строк в" +
				"\nв формах отчета \"Укомплектованность оперативных планов\" и" +
				"\nподсчета количества непереданных позиций на сбыт в форме отчета \"Контроль передачи на сбыт\"," +
				"\nработает ТОЛЬКО с книгами формата .xlsx (формат Excel начиная с версии 2007 года)." +
